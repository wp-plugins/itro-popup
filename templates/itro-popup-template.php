<div id="itro_popup">
	...
	if ( itro_get_option('age_restriction') == NULL ) 
		{?>
			<img id="close_cross" src="<?php echo itroPath . 'images/close-icon.png'; ?>" title="<?php _e('CLOSE','itro-plugin'); ?>" onclick="itro_popup.style.visibility='Hidden',itro_opaco.style.visibility='Hidden'">
