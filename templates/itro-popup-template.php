...
<div id="popup">
	...
	{?>
		<img src="<?php echo itroPath . 'images/close-icon.png'; ?>" title="<?php _e('CLOSE','itro-plugin'); ?>" style="cursor:pointer; width:20px; position:absolute; top:0px; right:0px;" onclick="popup.style.visibility='Hidden',opaco.style.visibility='Hidden'">
